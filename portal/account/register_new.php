            ...
            <div class="row setup-content" id="step-1">
                <div class="col-xs-12 col-md-7 col-md-offset-3 text-center">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="controls inline-inputs">
                                        ...
                                        <input id="dob" type="text" style="width: 100%" required class="form-control datepicker" placeholder="<?php echo xla('YYYY-MM-DD'); ?>" />
                        ...
                        <button class="btn btn-primary nextBtn btn-sm pull-right"  type="button" id="submitPatient"><?php echo xlt('Register') ?></button>
                    </fieldset>
                </div>
            </div>
        </form>
<!-- Profile Form -->
        <!-- <form class="form-inline" id="profileForm" role="form" action="account.php" method="post">
            <div class="row setup-content" id="#" style="display: none">
...
<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-md reg_poup" role="document">
