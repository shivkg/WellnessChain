...
if(isset($_POST['action'])){
 ...
 $to = $_POST['emailInput'];
 $subject = "Registration confirmation on Wellnesschain";
  $message = "
        <html>
        <head>
        ...
        Welcome to Wellness Chain!<br>

        You have received this message as you have given this e-mail address 
        during registration at www.wellnesschain.com.<br>

        To proceed with registration, please click on <br>
         http://13.251.197.241/portal/confirm.php?id=$patient_id
        </p>
        ...
        mail($to,$subject,$message,$headers);
            ...
            echo "<script>alert('Your new credentials have been sent. Check your email inbox and also possibly your spam folder')</script>";
            ...
            <div class="row">
                <div class="col-xs-12 col-md-7 col-md-offset-3 text-center">
                    <fieldset>
                        ...
                        <input type="submit"  class="btn btn-primary nextBtn btn-sm pull-right" value="Submit">
                    </fieldset>
                </div>
            </div>
        </form>
