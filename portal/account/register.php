...
<!-- <script type="text/javascript">
    $(document).ready(function(){
        $('#validations').click(function(){
             if($('#mobile').val()=='')   
          {
          alert("Require mobile no with country code");
          $('#mobile').focus();
          return false;
          } 
...
if(isset($_POST['action'])){
           ...
           $emailCheck = "SELECT email FROM patient_data where email = '".$_POST['emailInput']."'";
           $emailcheckResult = sqlStatement($emailCheck);
            while ($frow = sqlFetchArray($emailcheckResult)) {
                $email = $frow['email'];
            }
            if(empty($email)){
                $insertUserSQL =
                "insert into patient_data set 
                    ...
                    mname = '".$_POST['mname']."',      
                    lname = '".$_POST['lname'] ."',
                    phone_cell = '".$_POST['carrierCode'] ."',
                    DOB = '"  .$_POST['dob'] ."',
                    email = '". $_POST['emailInput'] ."'
                ";
                $hash = oemr_password_hash($_POST['password'], "$2a$05$Kd4WAB.lYG.tYa1tL3xxWc$");
                $lastid=sqlInsert($insertUserSQL);
                
                $insertquwey="insert into patient_access_onsite set pid='$lastid',
                 portal_pwd='".$hash."',portal_salt='$2a$05$Kd4WAB.lYG.tYa1tL3xxWc$',portal_username='".$patient_id."', portal_email='".$_POST['emailInput']."' ";
                ...
                sqlInsert($insertquwey);

                $insertUserpid ="UPDATE patient_data SET pid='".$lastid."' WHERE id='".$lastid."'";
                sqlInsert($insertUserpid);
           
            }else{
                echo "<script>alert('Email Already Taken.')</script>";
                echo '<script>window.location = "http://13.251.197.241/portal/account/register.php";</script>';
            }
...
<body class="skin-blue" id="particles-js">
    <div class="regi_bg">
    <div class="container">
        <form class="form-inline" id="startForm" role="form" action="" method="post" onSubmit="return validate()">
            <input type="hidden" name="action" value="get_newpid">
            <div class="row">
                <div class="col-xs-12 col-md-7 col-md-offset-3 text-center">
                    <fieldset>
                        <legend class='bg-primary'><?php echo xlt('Register') ?></legend>
                        <div class="well">
                        <?php if ($GLOBALS['language_menu_login']) { ?>
                        <?php if (count($result3) != 1) { ?>
                        <div class="form-group row lang_filed">
                            <label for="selLanguage"><?php echo xlt('Language'); ?></label>
                            <select class="form-control lang" id="selLanguage" name="languageChoice">
                            <?php
                        ...
                        <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group inline">
                                        ...
                                        <div class="controls inline-inputs">
                                            <input type="text" class="form-control" name="fname" required placeholder="<?php echo xla('First Name'); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group inline">
                                        <label class="control-label" for="mname"><?php echo xlt('Middle')?></label>
                                        <div class="controls inline-inputs">
                                            <input type="text" class="form-control" name="mname" placeholder="<?php echo xla('Full or Initial'); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group inline">
                                        <label class="control-label" for="lname"><?php echo xlt('Last Name')?></label>
                                        <div class="controls inline-inputs">
                                            <input type="text" class="form-control" name="lname" required placeholder="<?php echo xla('Enter Last'); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group inline">
                                        ...
                                        <div class="controls inline-inputs">
                                        <input name="emailInput" type="email" class="form-control" style="width: 100%" required
                             ...
                             <div class="row">
                                <div class="col-sm-6 form-group">
                                    <label class="control-label" for="lname"><?php echo xlt('Mobile No:')?></label>
                                        <div class="controls inline-inputs">
                                            <div class="input-phone" id="mobile"></div>
                                        </div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="controls inline-inputs">
                                        ...
                                        <input name="dob" type="text" style="width: 100%" required class="form-control datepicker" placeholder="<?php echo xla('YYYY-MM-DD'); ?>" />
                                ...
                                <div class="col-sm-6 form-group">
                                    <label class="control-label"  for="password"><?php echo xlt('Enter password')?></label>
                                    <div class="controls inline-inputs">
                                        <input name="password" type="password" id="password" class="form-control" style="width: 100%" required
                                            placeholder="<?php echo xla('Enter password.'); ?>" maxlength="100">
                                    </div>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label class="control-label"  for="cpassword"><?php echo xlt('Enter confirm password')?></label>
                                    <div class="controls inline-inputs">
                                        <input name="cpassword" id="cpassword" type="password" class="form-control" style="width: 100%" required
                                            placeholder="<?php echo xla('Enter confirm password.'); ?>" maxlength="100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <input type="submit" id="validations"  class="btn btn-primary nextBtn btn-sm pull-right" value="Submit">
                    </fieldset>
                </div>
            </div>
        </form>
...
<script type="text/javascript" src="./../assets/js/country_field.min.js"></script>
 <script>
  $(document).ready(function() {
