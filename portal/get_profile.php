...
<div class='demographics table-responsive' id='DEM'>
    <div class="col-sm-12">
        ...
        <div class="panel panel-primary" >
                ...
                <div class="panel-body profile_data" id="dempanel">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class='insurance table-condensed table-responsive'>
                <div class="panel panel-primary">
                    <header class="panel-heading"><i class="mr-10 fa fa-users" aria-hidden="true"></i><?php echo xlt('Primary Insurance');?></header>
        ...
        <?php
                ...
                <div class="panel panel-primary">
                    <header class="panel-heading"><i class="mr-10 fa fa-users" aria-hidden="true"></i><?php echo xlt('Secondary Insurance');?></header>
                    <div class="panel-body">
        <?php
                ...
                <div class="panel panel-primary">
                    <header class="panel-heading"><i class="mr-10 fa fa-users" aria-hidden="true"></i><?php echo xlt('Tertiary Insurance');?></header>
                    <div class="panel-body">
        <?php
