...
<table border='0' width='100%'>
 ...
 <tr>
  ...
  <input class="form-control input-sm" type='text' size='1' name='form_duration' value='<?php echo $row['pc_duration'] ? ($row['pc_duration']*1/60) : "0" ?>' readonly /><?php echo xl('minutes'); ?>
	...
	<tr>
		<td nowrap>
			<b><?php xl('Desises', 'e'); ?>:</b>
		</td>
		<td style='padding:0px 5px 5px 0' nowrap>
			  <input type="search" class="form-control" name='form_desisessearch_ae1' id='form_provider_ae1' onchange='change_desises(this);' placeholder="search  diseases ad press enter" />
			  <br/>
				<select name="form_desisessearchresult_ae" id="form_desisessearchresult_ae" style="display:none;"> 
				</select>
		</td>    
    </tr>
	<tr>
...
&nbsp;
<input type='button' name='form_delete' class='btn btn-success btn-md' value='<?php xl('Delete', 'e');?>' onclick="deleteEvent()" />
&nbsp;
</p>
</form>
<script>
...
<?php require($GLOBALS['srcdir'] . "/restoreSession.php"); ?>
 ...
 // here custom code use by sugham
 function change_desises(thisobj) {
		var style_apptstatus = document.getElementById('form_desisessearchresult_ae').style;	
	if(thisobj.value)
	 {
	   
		$("#form_desisessearchresult_ae").load("./get_hospital_desises.php", {'embeddedScreen': true}, function () {
