...
$("#reports").load("./report/portal_patient_report.php?pid='<?php echo attr($pid) ?>'", {'embeddedScreen': true}, function () {
    ...
    <table class="table table-striped table-condensed table-bordered">
        <tr class="header">
        <th><?php echo xlt('Report Date'); ?></th>
        <th><?php echo xlt('Report Name'); ?></th>
        ...
        <th><?php echo xlt('Download Report'); ?></th>
    ...
    // results that do not have a matching result type.
        ...
        while ($rrow = sqlFetchArray($rres)) {
            if ($even) {
                ...
                echo "<td><a href='#reportpanel' data-toggle='collapse'
                        data-parent='#panelgroup'>Click Here</a></td>";
                echo "</tr>";
        }
    }
