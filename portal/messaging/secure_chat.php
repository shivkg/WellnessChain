    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2 sidebar">
                ...
                <label ng-repeat="user in chatusers | unique : 'username'" ng-if="pusers.indexOf(user.recip_id) !== -1 && user.recip_id != me.sender_id">
                    <input type="radio" name="chat" data-checklist-model="pusers" data-checklist-value="user.recip_id"> {{user.username}}
                </label>
        ...
        <div class="col-md-2 rtsidebar">
                ...
                <label ng-repeat="ol in onlines | unique : 'username'">
                    <input type="radio" name="chat" data-checklist-model="onlines" data-checklist-value="ol"> {{ol.username}}
                </label>
            </div>
    </div>
