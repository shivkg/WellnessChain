...
! function(d) {
    ...
    A.VERSION = "0.0.1", A.DEFAULTS = {
        ...
        template: '<div class="input-group"><div class="input-group-btn"><button type="button" id="btn-country" class="btn btn-default  f16 dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="flag @cca2 btn-flag"></span><span id="field1" class="btn-cc" onchange="onchanges();">&nbsp;&nbsp; +@callingCode &nbsp;&nbsp;</span><span class="caret"></span></button> <ul class="dropdown-menu f16">@country_items</ul></div><input type="text" name="phoneNumber" id="phoneNumber" class="form-control phoneNumber" placeholder="Phone Number" size="25" /><input type="hidden" name="defaultCountry" id="defaultCountry" size="2" value="@cca2" /><input type="hidden" name="carrierCode" id="carrierCode" size="2" value="@callingCode" /></div>'
    ...
    function r(d, N) {
        ...
        d: {
            for (A in d)
                if (N.call(void 0, d[A], A, d)) break d;
            A = void 0
        }
        return A && d[A]
    }
    ...
    function Ad(d, N, A, $) {
        var e = T(N, 2),
            ...
            n = T(N, 5),
            a = "";
        return 2 == A && null != $ && 0 < $.length && 0 < n.length ? (N = n.replace(sN, $), e = e.replace(rN, N), a = d.replace(t, e)) : (N = T(N, 4), a = 2 == A && null != N && 0 < N.length ? d.replace(t, e.replace(rN, N)) : d.replace(t, e)), 3 == A && (a = a.replace(RegExp("^[-xâ€-â€•âˆ’ãƒ¼ï¼-ï¼  Â­â€‹â ã€€()ï¼ˆï¼‰ï¼»ï¼½.\\[\\]/~â“âˆ¼ï½ž]+"), ""), a = a.replace(RegExp("[-xâ€-â€•âˆ’ãƒ¼ï¼-ï¼  Â­â€‹â ã€€()ï¼ˆï¼‰ï¼»ï¼½.\\[\\]/~â“âˆ¼ï½ž]+", "g"), "-")), a
    }
    ...
    var Dd = (/\uffff/.test("ï¿¿") ? /[\\\"\x00-\x1f\x7f-\uffff]/g : /[\\\"\x00-\x1f\x7f-\xff]/g, 1),
        Kd = 2,
        Ud = 3,
        Fd = 4,
        Vd = 6,
    ...
    var Xd = {
        ...
        NN = /[\d]+(?:[~\u2053\u223C\uFF5E][\d]+)?/,
        AN = (RegExp("[+ï¼‹]+"), RegExp("^[+ï¼‹]+")),
        $N = RegExp("([0-9ï¼-ï¼™Ù -Ù©Û°-Û¹])"),
        eN = RegExp("[+ï¼‹0-9ï¼-ï¼™Ù -Ù©Û°-Û¹]"),
        tN = /[\\\/] *x/,
        nN = RegExp("[^0-9ï¼-ï¼™Ù -Ù©Û°-Û¹A-Za-z#]+$"),
        aN = /(?:.*?[A-Za-z]){3}.*/,
        iN = RegExp("(?:;ext=([0-9ï¼-ï¼™Ù -Ù©Û°-Û¹]{1,7})|[  \\t,]*(?:e?xt(?:ensi(?:oÌ?|Ã³))?n?|ï½…?ï½˜ï½”ï½Ž?|[,xï½˜#ï¼ƒ~ï½ž]|int|anexo|ï½‰ï½Žï½”)[:\\.ï¼Ž]?[  \\t,-]*([0-9ï¼-ï¼™Ù -Ù©Û°-Û¹]{1,7})#?|[- ]+([0-9ï¼-ï¼™Ù -Ù©Û°-Û¹]{1,5})#)$", "i"),
        oN = RegExp("^[0-9ï¼-ï¼™Ù -Ù©Û°-Û¹]{2}$|^[+ï¼‹]*(?:[-xâ€-â€•âˆ’ãƒ¼ï¼-ï¼  Â­â€‹â ã€€()ï¼ˆï¼‰ï¼»ï¼½.\\[\\]/~â“âˆ¼ï½ž*]*[0-9ï¼-ï¼™Ù -Ù©Û°-Û¹]){3,}[-xâ€-â€•âˆ’ãƒ¼ï¼-ï¼  Â­â€‹â ã€€()ï¼ˆï¼‰ï¼»ï¼½.\\[\\]/~â“âˆ¼ï½ž*A-Za-z0-9ï¼-ï¼™Ù -Ù©Û°-Û¹]*(?:;ext=([0-9ï¼-ï¼™Ù -Ù©Û°-Û¹]{1,7})|[  \\t,]*(?:e?xt(?:ensi(?:oÌ?|Ã³))?n?|ï½…?ï½˜ï½”ï½Ž?|[,xï½˜#ï¼ƒ~ï½ž]|int|anexo|ï½‰ï½Žï½”)[:\\.ï¼Ž]?[  \\t,-]*([0-9ï¼-ï¼™Ù -Ù©Û°-Û¹]{1,7})#?|[- ]+([0-9ï¼-ï¼™Ù -Ù©Û°-Û¹]{1,5})#)?$", "i"),
        rN = /(\$\d)/,
        cN = /\$NP/,
        lN = /\$FG/,
        sN = /\$CC/,
        uN = new x;
    E(uN, 11, "NA");
    var pN = (RegExp("^[-xâ€-â€•âˆ’ãƒ¼ï¼-ï¼  Â­â€‹â ã€€()ï¼ˆï¼‰ï¼»ï¼½.\\[\\]/~â“âˆ¼ï½ž]*(\\$\\d[-xâ€-â€•âˆ’ãƒ¼ï¼-ï¼  Â­â€‹â ã€€()ï¼ˆï¼‰ï¼»ï¼½.\\[\\]/~â“âˆ¼ï½ž]*)+$"), ["phoneNumberParser"]),
        gN = Cd;
