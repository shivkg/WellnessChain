 ...
 * Copyright (C) 2016-2017 Jerry Padgett <>
 *
...
<body class="skin-blue" onunload='imclosing()' onLoad="cursor_pointer();"
    ...
    <?php $NameNew=$patdata['fname'] . " " .$patdata['lname']. " " .$patdata['mname'];?>
            ...
            <tr id="tr_radio1" style="display: none" >
               <!--  <div name="radio_type_of_payment" id="radio_type_of_payment_self1"  > -->
                <td class='text'>
    <?php echo xlt('Payment Method'); ?>:
  </td>         
                <td colspan='2'><select name="form_method radio_type_of_payment" id="form_method radio_type_of_payment_self1"
