...
class ApplicationTable
{
    ...
    public function portalLog($event = '', $patient_id = null, $comments = "", $binds = '', $success = '1', $user_notes = '', $ccda_doc_id = 0)
    {
        ...
        $user = isset($_SESSION['email']) ? $_SESSION['email'] : $_SESSION['authUser'];
        $log_from = isset($_SESSION['email']) ? 'onsite-portal' : 'portal-dashboard';
        if (!isset($_SESSION['email']) && !isset($_SESSION['authUser'])) {
