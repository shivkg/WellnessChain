...
<div class="container text-center">
    <?php if (isset($_SESSION['password_update']) || isset($_GET['password_update'])) {
      ...
      <div id="wrapper" class="centerwrapper" style="text-align:center;">
        <h2 class="title" style="color: #fff;"><?php echo xlt('Please Enter a New Password'); ?></h2>
        <form action="get_patient_info.php" method="POST" onsubmit="return process_new_pass()" >
            <table style="width:100%; color: #fff;">
                <tr>
                    <td class="text-left"><?php echo xlt('User Name'); ?></td>
                    <td><input class="form-control" name="uname" id="uname" type="text" autocomplete="off" value="<?php echo attr($_SESSION['portal_username']); ?>"/></td>
                </tr>
                <tr>
                    <td class="text-left"><?php echo xlt('Current Password');?></td>
                    <td>
                        <input class="form-control" name="pass" id="pass" type="password" autocomplete="off" value="" />
                    </td>
                </tr>
                <tr>
                    <td class="text-left"><?php echo xlt('New Password');?></td>
                    <td>
                        <input class="form-control" name="pass_new" id="pass_new" type="password" />
                    </td>
                </tr>
                <tr>
                    <td class="text-left"><?php echo xlt('Confirm New Password');?></td>
                    <td>
                        <input class="form-control" name="pass_new_confirm" id="pass_new_confirm" type="password" />
                    </td>
                </tr>
                 <tr>
                    <td class="text-left"><?php echo xlt('Confirm Email Address');?></td>
                    <td>
                        <input class="form-control" name="passaddon" id="passaddon" placeholder="<?php echo xla('Your on file email address'); ?>" type="email" autocomplete="off" value=""  />
                    </td>
                </tr>
                <tr>
                	
                    <td colspan=2><br><input class="pull-right btn btn-default btn-lg login_btn" type="submit" value="<?php echo xla('Log In');?>" /></td>
                </tr>
            </table>
        </form>
            ...
            <div class="row">
                <div class="col-sm-10 col-md-offset-1 text-center">
                    <fieldset>
                        ...
                        <button id="submitRequest" class="confirm_btn pull-right" type="button"><?php echo xlt('Verify') ?></button>
                    </fieldset>
                </div>
            </div>
        </form>
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="controls inline-inputs">
                                        <input class="form-control" style="width: 100%" name="passaddon" id="passaddon" placeholder="<?php echo xla('on file email'); ?>" type="email" required  autocomplete="on" />
                                    </div>
                                    </div>
                                    <div class="form-group inline">
                        ...
                        <div class="col-sm-12 col-md-12">
                                ...
                                <a href="#" class="forget_btn"onclick="location.replace('./index.php?requestNew=1')"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Forget Password</a>
                          
                            <?php if ($GLOBALS['portal_two_pass_reset'] && isset($_GET['w']) && (isset($_GET['u']) || isset($_GET['p']))) { ?>
                               <button class="btn btn-danger" onclick="location.replace('./index.php?requestNew=1')" style="margin-left:10px"><?php echo xlt('Forget Your Password');?></button>
                            <?php } ?>
                                <button  class="btn btn-success confirm_btn pull-right" type="submit" ><?php echo xlt('Log In');?></button>
                        </div>
                    </fieldset>
                </div>
          </div>
