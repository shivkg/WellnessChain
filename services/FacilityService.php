...
require_once("facilityService_blockchain_api.php"); //added by vijay
...
class FacilityService
{
    ...
    public function update($data)
    {
        ...
        $data_array = array (
                        "id" => strval($data["fid"]),
                        "name" =>   add_escape_custom($data["name"]),
                        "phone" =>   add_escape_custom($data["phone"]),
                        "fax" =>   add_escape_custom($data["fax"]),
                        "street" =>   add_escape_custom($data["street"]),
                        "city" =>   add_escape_custom($data["city"]),
                        "state" =>   add_escape_custom($data["state"]),
                        "postal_code" =>   add_escape_custom($data["postal_code"]),
                        "country_code" =>   add_escape_custom($data["country_code"]),
                        "federal_ein" =>   add_escape_custom($data["federal_ein"]),
                        "website" =>   add_escape_custom($data["website"]),
                        "email" =>   add_escape_custom($data["email"]),
                        "color" =>   add_escape_custom($data["color"]),
                        "service_location" =>   add_escape_custom($data["service_location"]),
                        "billing_location" =>   add_escape_custom($data["billing_location"]),
                        "accepts_assignment" =>   add_escape_custom($data["accepts_assignment"]),
                        "pos_code" =>   add_escape_custom($data["pos_code"]),
                        "domain_identifier" =>   add_escape_custom($data["domain_identifier"]),
                        "attn" =>   add_escape_custom($data["attn"]),
                        "tax_id_type" =>   add_escape_custom($data["tax_id_type"]),
                        "primary_business_entity" =>   add_escape_custom($data["primary_business_entity"]),
                        "facility_npi" =>   add_escape_custom($data["facility_npi"]),
                        "facility_code" =>   add_escape_custom($data["facility_code"]),
                        "facility_taxonomy" =>   add_escape_custom($data["facility_taxonomy"]),                                

                  );
        facilityblockChainPush( "update", $data_array , $data["fid"], 'hospital' ); 
    ...
    public function insert($data)
    {
        ...
        //vijay
        //die("vijay");
        $hospital_id = sqlInsert($sql);
        $data_array = array (
                        "id" => strval($hospital_id),
                        "name" =>   add_escape_custom($data["name"]),
                        "phone" =>   add_escape_custom($data["phone"]),
                        "fax" =>   add_escape_custom($data["fax"]),
                        "street" =>   add_escape_custom($data["street"]),
        ...
        facilityblockChainPush( "insert", $data_array , $hospital_id, 'hospital' ); 
        return $hospital_id;
        //calling function 
