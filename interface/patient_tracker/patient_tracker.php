...
<head>
  ...
  <!--   <script type="text/javascript" src="<?php echo $GLOBALS['web_root']; ?>/interface/main/messages/js/jquery.canvasjs.min.js?v=<?php echo $v_js_includes; ?>"></script> -->
...
<body class="body_top">
 ...
 <section class="das_board">
    <div>
        <div class="row">
            <div class="title" style="text-align: center;"><?php echo xlt('Dashboard'); ?></div>
            <div class="col-md-2">
                <a href="/interface/main/finder/dynamic_finder.php">
     <div class="hospital clm">
        ...
        <span><?php echo $ProductRow;?></span>
            ...
            <div class="col-md-2">
                 <a href="/interface/usergroup/facilities.php">
     <div class="hospital clm">
     ...
     <?php
        ...
        <span><?php echo $FacilityRow;?></span>
            ...
            <div class="col-md-2">
                 <a href="/interface/usergroup/usergroup_admin.php">
     <div class="hospital clm">
        ...
        <span><?php echo $Userscount;?></span>
            ...
            <div class="col-md-2">
     <a href="/controller.php?practice_settings&amp;insurance_company&amp;action=list">
     <div class="hospital clm">
        
         <i class="fa fa-industry" aria-hidden="true"></i>
            <p> Insurance List</p>
            <?php
                $GetAppointment = "SELECT * FROM insurance_companies ";
                $RunAppointment = $con->query($GetAppointment);
                 $AppointmentRow = mysqli_num_rows($RunAppointment);
                 $insurance=$AppointmentRow-6;
        ...
        <span><?php echo $insurance;?></span>
            ...
            <div class="col-md-2">
                 <a href="/controller.php?practice_settings&amp;pharmacy&amp;action=list">
     <div class="hospital clm">
         <i class="fa fa-user-md" aria-hidden="true"></i>
            <p>Pharmacies List</p>
     <?php
        $PharmaciesGet = "SELECT * FROM pharmacies ";
        $RunPharmaciesGet = $con->query($PharmaciesGet);
         $PharmaciesRow = mysqli_num_rows($RunPharmaciesGet);
           
           ?>
        <span><?php echo $PharmaciesRow;?></span>
     </div></a>
            </div>
            <div class="col-md-2">
                 <a href="/interface/drugs/drug_inventory.php">
     <div class="hospital clm">
         <i class="fa fa-puzzle-piece" aria-hidden="true"></i>
            <p>Medicine List</p>
            <?php
                $MedicineGet = "SELECT * FROM drugs ";
                $MedicineRun = $con->query($MedicineGet);
                 $MedicineRow = mysqli_num_rows($MedicineRun);
                   
                   ?>

        <span><?php echo $MedicineRow;?></span>
     </div></a>
            </div>
