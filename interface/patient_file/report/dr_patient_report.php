...
<a href="dr_patient_report.php?printable=1&<?php print postToGet($ar); ?>" class='link_submit' target='new' onclick='top.restoreSession()'>
...
if ($printable && ! $PDF_OUTPUT) {// Patched out of pdf 04/20/2017 sjpadgett
    echo "<br /><br />" . xl('Signature') . ": _________________________________<br />";
}
?>
...
<div class="text demographics" id="DEM">
    ...
    <table>
        <tbody>
            <tr>
                <td class="groupname">Who</td>
                <td class="label_custom" colspan="1">Name:</td>
                <td class="text data" colspan="1">Mr.DeepankarJoshi</td>
                <td class="label_custom" colspan="1">External ID:</td>
                <td class="text data" colspan="1">14</td>
            </tr>
            <tr>
                <td valign="top"></td>
                <td class="label_custom" colspan="1">DOB:</td>
                <td class="text data" colspan="1">1984-08-15</td>
                <td class="label_custom" colspan="1">Sex:</td>
                <td class="text data" colspan="1">Male</td>
            </tr>
            <tr>
                <td valign="top"></td>
                <td class="label_custom" colspan="1">Marital Status:</td>
                <td class="text data" colspan="3">Married</td>
            </tr>
            <tr>
                <td class="groupname">Contact</td>
                <td class="label_custom" colspan="1">Address:</td>
                <td class="text data" colspan="1">2/10 UIT BHIWADI, Distt-Alwar</td>
                <td class="label_custom" colspan="1">City:</td>
                <td class="text data" colspan="1">BHIWADI</td>
            </tr>
            <tr>
                <td valign="top"></td>
                <td class="label_custom" colspan="1">State:</td>
                <td class="text data" colspan="1">Maryland</td>
                <td class="label_custom" colspan="1">Postal Code:</td>
                <td class="text data" colspan="1">301019</td>
            </tr>
            <tr>
                <td valign="top"></td>
                <td class="label_custom" colspan="1">County:</td>
                <td class="text data" colspan="1">india</td>
                <td class="label_custom" colspan="1">Contact Email:</td>
                <td class="text data" colspan="1">deepuleo.91@gmail.com</td>
            </tr>
            <tr>
                <td class="groupname">Choices</td>
                <td class="label_custom" colspan="1">Provider:</td>
                <td class="text data" colspan="3"> </td>
            </tr>
            <tr>
                <td valign="top"></td>
                <td class="label_custom" colspan="1">Allow Patient Portal:</td>
                <td class="text data" colspan="1">YES</td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td class="groupname">Stats</td>
                <td class="label_custom" colspan="1">Financial Review Date:</td>
                <td class="text data" colspan="1">1970-01-01 00:00:00</td>
                <td></td>
                <td></td>
            </tr>
        </tbody>
...
<div class="text insurance">
    ...
    <br><span class="bold">Primary Insurance Data:</span>
    <br>
    <table>
        <tbody>
            <tr>
                <td valign="top"><span class="bold">Plan Name: </span>
                    <br><span class="text">Religare Ayush<br></span></td>
                <td valign="top"><span class="bold">Policy Number: </span>
                    <br><span class="text">122h3u3<br></span></td>
                <td valign="top"><span class="bold">Group Number: </span>
                    <br><span class="text">Group<br></span></td>
                <td valign="top"><span class="bold">Subscriber Date of Birth: </span>
                    <br><span class="text">0000-00-00<br></span></td>
            </tr>
        </tbody>
    </table>
    <span class="bold">Secondary Insurance Data:</span>
    <br>
    <table>
        <tbody>
            <tr>
    ...
    <span class="bold">Tertiary Insurance Data:</span>
    <br>
    <table>
        <tbody>
            <tr>
