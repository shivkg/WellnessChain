...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class= "row">
                <p><?php echo xlt("A large application like Wellness Chain is used by a multitude of users with varying roles and degrees of responsibility. It is imperative that access to various parts of the program be granted to users on a need to know basis. To achieve this - Access Control Lists (ACL) are used.");?>

                <p><?php echo xlt("These lists are used to determine who can access what in Wellness Chain. They work in a top down manner, i.e. initially everybody is denied access to those parts of the program controlled by the ACL.");?>
