...
require_once("blockchain_api.php"); //added by vijay
    ...
    if ($_POST["mode"] == "update") {
      ...
      //Display message when Emergency Login user was activated
       ...
       //vijay
            ...
            //calling function 
            userblockChainPush( "update", $data_array , $_POST["id"], 'doctor' );   
          ...
          //if password expiration option is enabled,  calculate the expiration date of the password
            if ($GLOBALS['password_expiration_days'] != 0) {
              ...
              $insertUserSQL=
               ...
               $user_id = sqlInsert($insertUserSQL);
            ...
            //calling function 
            userblockChainPush( "insert", $data_array , $user_id,'doctor' );           
...
<div class="user_search_box">
    <input class="search_box" type="text" name="search" placeholder="search user name" id="user_search" onkeyup="myFunction()">
</div>
