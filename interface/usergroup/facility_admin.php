...
<form name='facility-form' id="facility-form" method='post' action="facilities.php">
    ...
    <table border=0 cellpadding=0 cellspacing=1 style="width:630px;">
        ...
        <tr>
            ...
            <td><span class=text><?php xl('Tax ID', 'e'); ?>: </span></td><td><select style="padding: 6px;" name=tax_id_type><option value="EI" <?php echo $ein;?>><?php xl('EIN', 'e'); ?></option><option value="SY" <?php echo $ssn;?>><?php xl('SSN', 'e'); ?></option></select><input type=entry size=11 name=federal_ein value="<?php echo htmlspecialchars($facility["federal_ein"], ENT_QUOTES) ?>"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="4"><input class="form-control" type="text" name="attn" size="45" value="<?php echo htmlspecialchars($facility['attn'], ENT_QUOTES) ?>"></td>
        </tr>
        <tr>
            <td><span class="text"><?php xl('CLIA Number', 'e'); ?>:</span></td>
            <td colspan="4"><input class="form-control" type="text" name="domain_identifier" size="45" value="<?php echo htmlspecialchars($facility['domain_identifier'], ENT_QUOTES) ?>"></td>
        </tr>
        <tr>
            <td><span class="text"><?php xl('Facility ID', 'e'); ?>:</span></td>
            <td colspan="4"><input class="form-control" type="text" name="facility_id" size="45" value="<?php echo htmlspecialchars($facility['facility_code'], ENT_QUOTES) ?>"></td>
        </tr>
