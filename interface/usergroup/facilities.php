...
function myFunction() {
  ...
  input = document.getElementById("hospital_search");
   
  filter = input.value.toUpperCase();
  table = document.getElementById("hospital_table");
...
<div class="user_search_box">
    <input class="search_box" type="text" name="search" placeholder="search hospital name" id="hospital_search" onkeyup="myFunction()">
</div>

                <div class="table-responsive">
                    <table class="table table-striped" id="hospital_table">
                        <thead>
                            <tr>
