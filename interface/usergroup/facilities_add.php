...
<form name='facility-add' id='facility-add' method='post' action="facilities.php">
    ...
    <table border=0 cellpadding=0 cellspacing=0>
        ...
        <td>&nbsp;</td>
        <td><span class="text"><?php xl('Tax ID', 'e'); ?>: </span></td><td><select style="height: 34px;" name=tax_id_type><option value="EI"><?php xl('EIN', 'e'); ?></option><option value="SY"><?php xl('SSN', 'e'); ?></option></select><input type=entry size=11 name=federal_ein value=""></td>
        </tr>
        <tr>
    ...
    ?>
     <tr>
        ...
        <tr>
            ...
            <td colspan="4"><input class="form-control" type="text" name="attn" size="45"></td>
        </tr>
        <tr>
            <td><span class="text"><?php xl('CLIA Number', 'e'); ?>:</span></td>
            <td colspan="4"><input class="form-control" type="text" name="domain_identifier" size="45"></td>
        </tr>
        <tr>
            <td><span class="text"><?php xl('Facility ID', 'e'); ?>:</span></td>
            <td colspan="4"><input class="form-control" type="text" name="facility_id" size="20"></td>
        </tr>
