...
if ($form_step == 0) {
    ...
    echo "  <td><select name='vendor' class='form-control'>";
    ...
    echo "  <td><select name='action' class='form-control'>";
    ...
    echo "  <td><select name='group' class='form-control'>";
    ...
    echo "<input type='file' class='form-control' name='userfile' /></td>\n";
    echo " </tr>\n";
