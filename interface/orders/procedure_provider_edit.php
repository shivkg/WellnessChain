...
<table border='0' width='100%'>
 ...
 <tr>
  ...
  <td>
    <select name='form_name' id='form_name' class='inputtext form-control' style='width:150px'>
            <?php echo $optionsStr; ?>
    </select>
  </td>
 </tr>
 ...
 <tr>
  ...
  <td>
   <select name='form_DorP' class="form-control" title='<?php echo xla('MSH-11'); ?>'>
<?php
foreach (array(
  'D' => xl('Debugging'),
  'P' => xl('Production'),
...
?>
 ...
 <tr>
  ...
  <td>
   <select name='form_protocol' class="form-control">
<?php
foreach (array(
...
?>
   ...
   &nbsp;
   <select name='form_direction' class="form-control">
<?php
foreach (array(
  'B' => xl('Bidirectional'),
  'R' => xl('Results Only'),
