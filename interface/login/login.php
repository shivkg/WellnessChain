...
<html>
<head>
    <title>Wellness Chain Login</title>
        ...
        <form method="POST" id="login_form"
            ...
            <div class="row">
                ...
                <div class="col-sm-<?php echo $loginFormColumnCount;?>">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-default btn-lg login_btn" onClick="transmit_form()">&nbsp;&nbsp;<?php echo xlt('Login');?></button>
                         <a href="#" class="forget_btn pull-right"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Forget Password</a>
                    </div>
                </div>
