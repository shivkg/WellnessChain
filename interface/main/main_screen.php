<?php
/**
 * The outside frame that holds all of the Wellness Chain User Interface.
 *
...
// (allows creations of separate Wellness Chain frames to view patients concurrently
//  on different browser frame/windows)
// This session id is used below in the restoreSession.php include to create a
// session cookie for this specific Wellness Chain instance that is then maintained
// within the Wellness Chain instance by calling top.restoreSession() whenever
...
<?php include_once ("footereml.php");?>
