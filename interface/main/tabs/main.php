...
<div id="mainBox" <?php echo $disp_mainBox ?>>
    ...
    <div class="body_top">
        <a href="http://13.251.197.241/interface/main/tabs/main.php" title="Wellness Chain <?php echo xla("Website"); ?>" target="_blank"><img class="logo" alt="openEMR small logo"  border="0" src="<?php echo $GLOBALS['images_static_relative']; ?>/menu-logo.png"></a>
