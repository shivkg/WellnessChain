...
require_once('../../../library/appointment_blockchain_api.php');
...
//
    if ($_POST['form_action'] == "save") {
        ...
        // oct-08 JRM
                    ...
                    //start by vijay
                    $data_array = array (
                        "id" => strval(add_escape_custom($eid)),
                        "pc_catid" =>   add_escape_custom($_POST['form_category']),
                        ...
                        //"pc_eventstatus" =>   1 ,
                       // "pc_sharing" =>   1 ,
                        "pc_facility" =>   add_escape_custom((int)$_POST['facility']), 
                        "pc_billing_location" =>   add_escape_custom((int)$_POST['billing_facility'])   ,
                        "pc_room" =>    add_escape_custom($_POST['form_room']) 
                    );         
                    //calling function 
                    appointmentblockChainPush( "update", $data_array , $eid); 
                    //end by vijay
                }
            }
