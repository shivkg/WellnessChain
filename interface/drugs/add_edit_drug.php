<?php
 ...
 require_once("medicine_blockchain_api.php"); //added by vijay
    ...
    if ($drug_id) {
        if ($_POST['form_save']) { // updating an existing drug
            ...
            //start by vijay
              $data_array=array(
                  ...
                  medicineblockChainPush( "update", $data_array , $drug_id, 'medicine' );
            //end by vijay
        ...
        //start by vijay
          $data_array=array(
              ...
              medicineblockChainPush( "insert", $data_array , $drug_id, 'medicine' );
        //end by vijay
