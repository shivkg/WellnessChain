<?php
/**
 * This program is run by the Wellness Chain setup.php script to install phpGACL
 * and creates the Access Control Objects and their sections.
 * See Wellness Chain/library/acl.inc file for the list of
 ...
 *
 * Upgrade Howto
 * When upgrading to a new version of Wellness Chain, run the acl_upgrade.php
...
if ($gacl->add_object_section('Accounting', 'acct', 10, 0, 'ACO') === false) {
    echo "Unable to create the access controls for Wellness Chain.  You have likely already run this script (acl_setup.php) successfully.<br>Other possible problems include php-GACL configuration file errors (gacl.ini.php or gacl.class.php).<br>";
    return;
}
// xl('Accounting')
...
// If this script is being used by Wellness Chain's setup, then will
...
<html>
<head>
<title>Wellness Chain ACL Setup</title>
<link rel=STYLESHEET href="interface/themes/style_blue.css">
</head>
<body>
<b>Wellness Chain ACL Setup</b>
<br>
